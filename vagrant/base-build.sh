...
if [[ -e /etc/redhat-release ]]; then
  ...
  mkdir -p /home/vagrant/go/src/github.com/proxysql/orchestrator
  mount --bind /orchestrator /home/vagrant/go/src/github.com/proxysql/orchestrator

  # Build Orchestrator
  export GOPATH=/home/vagrant/go
  export GO15VENDOREXPERIMENT=1
  cd ${GOPATH}/src/github.com/proxysql/orchestrator
  /usr/bin/go get ./...
  ${GOPATH}/src/github.com/proxysql/orchestrator/build.sh
